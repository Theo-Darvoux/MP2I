...
\begin{prop}{}{}
    ...
    \begin{equation*}
        \Lg \l X + \mu X', Y \Rg = ( X + \mu X')^{\top}Y=\l X^{\top}Y + \mu X'^{\top}Y=\l\Lg X,Y \Rg + \mu \Lg X', Y \Rg
    \end{equation*}
    \bf{Positive:}
    \begin{equation*}
...
\begin{prop}{}{}
    ...
    \end{equation*}
    \bf{Symétrie:} Claire.\\
    \bf{Bilinéarité:} Suffisante à droite. Soient $A,B,B'\in M_{n,p}(\R)$ et $\l,\mu\in\R^2$.
    \begin{align*}
...
\begin{prop}{}{cinq}
    ...
    \end{equation*}
    \bf{Bilinéarité:} La linéarité  à gauche suffit. Soient $f,\tilde{f},g\in\C([a,b],\R)$ et $\l,\mu\in\R$.
    \begin{align*}
...
\begin{ex}{Des inégalités de Cauchy-Schwarz écrites au carré.}{}
