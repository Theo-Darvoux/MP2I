...
\begin{ex}{Tableaux dynamiques.}{}
    ...
    \begin{equation*}
        \frac{\sum_{i=1}^k c_i}{k} \leq \frac{\sum_{i=1}^k 1 + \sum_{j=0}^{\lf \log_\a k \rf}\a^j}{k} \leq 1 + \frac{\a^{\lf \log_\a k \rf+1}}{k} - \frac{1}{(\a-1)k} \leq 1 + \frac{ak}{k} = O(1)
    \end{equation*}
\end{ex}
...
\begin{meth}{Potentiels.}{}
    ...
    Alors le coût amorti d'une opération est égal à son coût réel moins la variation de $\Phi$ après son éxecution.
\end{meth}
