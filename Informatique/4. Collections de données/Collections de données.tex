...
\begin{defi}{Arbre binaire.}{}
    ...
    $\hra$ Soit c'est une arbre vide.\\
    $\hra$ Soit il est constitué d'un noeud et de deux arbre binaires disjoints, appelés \bf{fils gauche} et \bf{fils droit}.
\end{defi}
...
\begin{defi}{Arbre rouge-noir. $\star$}{}
    ...
    $\hra$ Les fils rouges d'un noeud noir sont noirs.\\
...
\begin{thm}{Complexité de tris par comparaisons. $\star$}{cmp}
    ...
    \end{equation*}
    On en conclut que $h=\Omega(n\log n)$.
\end{thm}
...
\begin{defi}{}{}
    ...
    On appelle \bf{clé} un élément de l'ensemble de départ et \bf{valeur} son élément associé. On peut :\\
