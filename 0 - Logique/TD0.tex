...
\begin{tcolorbox}[enhanced, width=6in, center, size=fbox, fontupper=\large, drop shadow southwest]
    ...
    \emph{Synthèse.}\\
    Posons $g: \begin{cases}\mathbb{R}\rightarrow\mathbb{R}\\x\mapsto{x+1}\end{cases}$. Montrons que $g$ est solution.\\
...
\begin{tcolorbox}[enhanced, width=6in, center, size=fbox, fontupper=\large, drop shadow southwest]
    ...
    \emph{Analyse.}\\
    Soit $(x,y)\in\mathbb{R}^2$.\\
    Lorsque $x=f(0), y=0$, $f(0)=1-f(0)$. Ainsi, $2f(0)=1$, donc $f(0)=\frac{1}{2}$.\\
    Lorsque $y=0$, $f(x-\frac{1}{2})=1-x$.\\
    Posons $z=x-\frac{1}{2}$.\\
    On a $f(z)=1-z-\frac{1}{2} = \frac{1}{2}-z$.\\
    Alors $f(x)=\frac{1}{2}-x$ \emph{(car $z\in\mathbb{R}$)}\\
    On en déduit que $f$ est unique si elle existe.\\
    \emph{Synthèse.}\\
    Posons $g:\begin{cases}\mathbb{R}\rightarrow\mathbb{R}\\x\mapsto{\frac{1}{2}-x}\end{cases}$. Montrons que $g$ est solution.\\
    Soient $(x,y)\in\mathbb{R}^2$.
    \begin{equation*}
